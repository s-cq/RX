    ...
    <div class="thinScroll pr10" v-scrollHeight="84">
        ...
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <p class="fl col-md-4">
                    ...
                    <span>{{debitItem.payMoney.toFixed(2)}}</span>
                </p>
                    <p class="fl col-md-4">
        ...
        <router-link tag="div" exact :to="routerPath('payDetailThreeRG?index= '+2+'')" class="analyItem anItemBor" active-class="anItemBor-active" >
            ...
            <div class="analyItemCon">
                <p class="fl col-md-4">
                    ...
                    <span class="c666">{{debitItem.workerAvailableMoney.toFixed(2)}}</span>
                </p>
                <p class="fl col-md-4">
                    <span class="cLightGray pr8" data-title="已付=出纳支付的（已付人工 + 已经结算款）">已付</span><br>
                    <span class="c666">{{debitItem.workerPayMoney.toFixed(2)}}</span>
                </p>
                <p class="fl col-md-4">
                    <span class="cLightGray pr8" data-title="未付 = 总未付 - 增项未付 - 材料未付 - 结算未付">未付</span><br>
                    <span class="c666">{{debitItem.workerUnPayMoney.toFixed(2)}}</span>
                </p>
            </div>
        </router-link>
        <!-- 材料款 -->
        <router-link tag="div" exact :to="routerPath('payDetailThreeCL?index= '+3+'')" class="analyItem anItemBor" active-class="anItemBor-active" >
            ...
            <div class="analyItemCon">
                <p class="fl col-md-4">
                    ...
                    <span class="c666">{{debitItem.materialAvailableMoney.toFixed(2)}}</span>
                </p>
                <p class="fl col-md-4">
                    <span class="cLightGray pr8" data-title="已付 = 出纳已付材料总额">已付</span><br>
                    <span class="c666">{{debitItem.materialPayMoney.toFixed(2)}}</span>
                </p>
                    <p class="fl col-md-4">
                        <span class="cLightGray pr8" data-title="未付 = 材料下单未支付的配送单">未付</span><br>
                            <span class="c666">{{debitItem.materialUnPayMoney.toFixed(2)}}</span>
                </p>
                <p class="col-md-3">
                </p>
            </div>
        ...
        <!-- <router-link tag="div" exact :to="routerPath('payDetailThreeCL?index= '+4+'')" class="analyItem anItemBor" active-class="anItemBor-active" > -->
            ...
            <div class="analyItemCon">
               <p class="fl col-md-4">
                   ...
                   <span class="c666">{{debitItem.sumIncreaseMoney.toFixed(2)}}</span>
               </p>
               <p class="fl col-md-4">
                   <span class="cLightGray pr8">已付</span><br>
                   <span class="c666">{{debitItem.increaseMoney.toFixed(2)}}</span>
               </p>
                   <p class="fl col-md-4">
                       <span class="cLightGray pr8">未付</span><br>
                           <span class="c666">{{debitItem.unIncreaseMoney.toFixed(2)}}</span>
                   </p>
        ...
        <router-link tag="div" exact :to="routerPath('payDetailThreeJS?index= '+5+'')" class="analyItem anItemBor" active-class="anItemBor-active" >
            ...
            <div class="analyItemCon">
                <p class="col-md-4">
                    <span class="cLightGray pr8">应付</span><br>
                    <span>{{debitItem.settlementMoney.toFixed(2)}}</span>
                </p>
                <p class="col-md-4">
                    <span class="cLightGray pr8">已付</span><br>
                    <span>{{debitItem.settlementAccounts.toFixed(2)}}</span>
                </p>
                <p class="col-md-4">
                    <span class="cLightGray pr8">未付</span><br>
                    <span>{{debitItem.settlementUnPayMoney.toFixed(2)}}</span>
                </p>
            </div>
        </router-link>
        <!-- 增项协调费 -->
        <router-link tag="div" exact :to="routerPath('payDetailThreeZXX?index= '+6+'')" class="analyItem anItemBor" active-class="anItemBor-active" >
            ...
            <div class="analyItemCon">
                <p class="fl col-md-4">
                    <span class="cLightGray pr8">应付</span><br>
                    <span class="c666">{{debitItem.coordinationMoney.toFixed(2)}}</span>
                </p>
                <p class="fl col-md-4">
                    <span class="cLightGray pr8">已付</span><br>
                    <span class="c666">{{debitItem.coordinationPayMoney.toFixed(2)}}</span>
                </p>
                <p class="fl col-md-4">
                    <span class="cLightGray pr8">未付</span><br>
                    <span class="c666">{{debitItem.coordinationUnPayMoney.toFixed(2)}}</span>
                </p>
                <!-- <div class="fixedTrangle">
                    <a href="javascript:" class="fixedtips"></a>
