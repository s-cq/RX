...
<div class="">
    <div class="pr10">
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                <p class="col-md-4">
                    <span class="pr8 cLightGray">预留</span>
                    <span class="cGreen">0个</span>
                </p>
                <p class="col-md-4">
                    <span class="pr8 cLightGray">预留</span>
                    <span class="cGreen">0个</span>
    ...
    <div class="thinScroll pr10" v-scrollHeight="84">
        <router-link tag="div" exact :to="routerPath('payDetailThree?index= '+index+'')" class="analyItem anItemBor" active-class="anItemBor-active" v-for="(item,index) in sceneList" :key="index">
            ...
            <div class="analyItemCon">
                ...
                <!-- <p class="col-md-4">
                    <span class="cGreen">{{item.currenStage}}</span>
                </p> -->
                <div v-if="index===2" class="fixedTrangle">
                 ...
                 <span><span class="circlemark circlemark-lightRed">未</span></span>
            </div>
        </router-link>
    </div>
    <div class="pr10">
