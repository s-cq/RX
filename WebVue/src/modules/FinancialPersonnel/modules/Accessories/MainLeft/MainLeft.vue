...
<div class="tc-left pr10 fl">
    <ul class="clearfix uiTab1 mb5 j_outerHeight">
        <li class="col-md-3 fl uiTab1-active"><a href="javascript:">辅料</a></li>
    </ul>
    ...
    <div class="contentbox">
        <table class="uiTable j_outerHeight">
            <thead>
                <tr>
                    ...
                    <th width="25%">品牌</th>
                    <th width="30%">规格</th>
                    <th width="15%"><i class="AddIcon AddIconNew"></i></th>
                </tr>
            </thead>
        </table>
        <div class="scroll-content thinScroll thinScroll-table" v-scrollHeight="36">
            <table class="uiTable uiTable-striped uiTable-hover" id="tab1">
                <tbody>
                    ...
                    <tr>
                        <td width="30%" title="普通烤漆玻璃">普通烤漆</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">5mm</td>
                        <td width="15%">72</td>
                    </tr>
                    ...
                    <tr>
                        <td width="30%" title="钢化烤漆玻璃">钢化烤漆</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">5mm</td>
                        <td width="15%">72</td>
                    </tr>
                    ...
                    <tr>
                        <td width="30%" title="超白普通烤漆玻璃">超白普通</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">5mm</td>
                        <td width="15%">72</td>
                    </tr>
                    ...
                    <tr>
                        <td width="30%" title="超白钢化烤漆玻璃">超白钢化</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">5mm</td>
                        <td width="15%">72</td>
                    </tr>
                    ...
                    <tr>
                        <td width="30%" title="轻钢龙骨">轻钢龙骨</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">38主骨/3M</td>
                        <td width="15%">72</td>
                    </tr>
                    <tr>
                        <td width="30%" title="轻钢龙骨">轻钢龙骨</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">50付骨/3M</td>
                        <td width="15%">72</td>
                    </tr>
                    <tr>
                        <td width="30%" title="轻钢龙骨">轻钢龙骨</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">75竖向/3M</td>
                        <td width="15%">72</td>
                    </tr>
                     <tr>
                        <td width="30%" title="轻钢龙骨">轻钢龙骨</td>
                        <td width="25%">瑞祥</td>
                        <td width="30%">75天地/3M</td>
                        <td width="15%">72</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="j_outerHeight clearfix tj_bottom">
            <p class="col-md-3" data-title="全部">14</p>
            <p class="col-md-3 cGreen" data-title="正常" >14</p>
