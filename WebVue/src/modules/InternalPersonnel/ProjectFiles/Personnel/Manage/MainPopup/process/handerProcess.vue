        ...
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="137">
            ...
            <div class="analyItem " active-class="anItemBor-active" exact>
                ...
                <div class="analyItemCon">
                    <p class="col-md-2 ">
                        <span class="cLightGray pr8">个数</span>
                        <span>{{safetyNumber3}}个</span>
                    </p>
                    <p class="col-md-2 ">
                        <span class="cLightGray pr8">接单完成</span>
                        <span>{{safetyCompleted3}}</span>
                    </p>
                    <p class="col-md-2 ">
                        <span class="cLightGray pr8">评价完成</span>
                        <span>{{safetyProcessing3}}</span>
                    </p>
                    <p class="col-md-2 ">
                        <span class="cLightGray pr8">总价</span>
                        <span>{{Number(priceCount3+chaoqiCount3)}}</span>
                    </p>
                </div>
            </div>
        ...
        <div class="layerRtb-footer">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    ...
                    <p class="col-md-2 ">
                        <span class="cLightGray pr8">总价</span>
                        <span>{{Number(priceCount+priceCount1+priceCount2-chaoqiCount-chaoqiCount1-chaoqiCount2+priceCount3+chaoqiCount3)+Number(workerMoney.worker_money*workerSum)}}</span>
                    </p>
                </div>
            </div>
        </div>
            ...
            getStayStayProcessOrderTypeDetailYearMonth({
                ...
                for (var i = 0; i < this.orderBody.length; i++) {
                    ...
                    case 28:
                        ...
                        switch (this.orderBody[i].orderStatus) {
                        case 0:
                            this.safetyCompleted3++
                            this.priceCount3 += this.orderBody[i].unit_price
                            break
                        case 1:
                            this.safetyProcessing3++
                            this.priceCount3 += this.orderBody[i].unit_price + this.orderBody[i].finish_price
                            break

                        case 3:
                            this.safetyUnopened3++
                            this.chaoqiCount3 += this.orderBody[i].unit_price
                            break
                        default:
                            break
                        }
