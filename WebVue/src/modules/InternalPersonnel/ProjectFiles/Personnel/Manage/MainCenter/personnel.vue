<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="routerPath('personnelEntrance1')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelInformation1')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelPosition1',params:{user:user,abilityLevel:abilityLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelGenerallevel1',params:{isGroup:isGroup,gradeByAbilityLevel:gradeByAbilityLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelManagementlevel1',params:{isGroup:isGroup,gradeByManageLevel:gradeByManageLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{path:routerPath('personnelTraining'), query: {pathUrl: peiObject !== null ? peiObject.jumpUrl : 'null'}}" class="analyItem anItemBor" active-class="anItemBor-active">
                <p class="analyItemTit tx-center">培训</p>
                <div class="analyItemCon">
                    <p class="fl col-md-4"><span class="cLightGray pr8">名称</span> <span>{{peiObject !== null ? peiObject.className : '--'}}</span></p>
                    <p class="fl col-md-4"><span class="cLightGray pr8">级别</span> <span>{{peiObject !== null ? peiObject.classLevel : '--'}}</span></p>
                    <p class="fl col-md-4"><span class="cLightGray pr8">时间</span> <span>{{peiObject !== null ? peiObject.startTime : '--'}}</span></p>
                    <span :class="['circlemark',peiObject.assessClass]" v-if="peiObject !== null">{{peiObject.assessText}}</span>
                </div>
            </router-link>
            <div class="analyItem">
            ...
            <router-link tag="div" :to="routerPath('personnelCertificate1')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelNotice1')" class="analyItem anItemBor" active-class="anItemBor-active" v-if="Number(userInfo.as_diquId) === 39">
        ...
        <div class="pr10">
            <router-link tag="div" :to="routerPath('personnelHandling1')" class="analyItem anItemBor" active-class="anItemBor-active">
...
<script>
import { getUseUseTwoEndUserDetail, selectComCareInfoUseHuman, getAppNoticeGroup, getLatelyClassTrainResultByCardNo } from '../Resources/Api'
...
export default {
    ...
    methods: {
        load () {
            ...
            var isapp = 5
            getAppNoticeGroup({ cardNo: this.leftInfo.cardNo, isapp }).then(result => {
