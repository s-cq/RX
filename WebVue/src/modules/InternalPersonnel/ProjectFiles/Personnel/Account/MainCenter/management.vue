<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'managementCompletion5',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'managementFine5',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'managementNegotiation5',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
