...
<div class="layerRtb layerRtb-threecolumn">
    ...
    <div class="layerRtb-scroll thinScroll" v-scrollHeight = "250">
        <div class="analyItem">
        ...
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <div class="col-md-12 pt5">
                    <p class="col-md-3"><span class="cLightGray pr8">标准</span><span>{{standValue === null ? '' : standValue}}万</span></p>
                    <p class="col-md-3"><span class="cLightGray pr8">实际</span><span class="cGreen">{{complete === null ? '' : complete}}万</span></p>
...
export default {
    ...
    computed: {
        ...
        Difference () {
            ...
            const completionMoney = this.complete ? this.complete : 0
