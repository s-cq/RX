            ...
            <div class="analyItem" v-for="(item,index) in allGradeList" :key="index">
                ...
                <div class="analyItemCon" :data-level='item.grade'>
                    ...
                    <p style="position: absolute;right: 10px;top: 10px;">
                        <input type="text" vlaue="1" :class="[ item.grade == gradeByManageLevel.grade ? ' judge-span judge-yes active' : 'judge-span judge-yes']" :data-level='allGradeList.grade' @click="openMessageBox(item.grade,1)">
...
export default {
    ...
    methods: {
        ...
        saveInternelUserLevelByManageFn (ManageLeve, yesorno, remark) {
