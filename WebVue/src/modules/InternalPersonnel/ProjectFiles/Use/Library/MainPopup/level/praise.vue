<template>
    <div class="layerRtb layerRtb-threecolumn">
        <three-title :title="{name:'增项'}"></three-title>
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="137">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    ...
                    <div class="col-md-4">
                        ...
                        <span v-if="bzedit === 0">{{userLevelStandardDetail.greatMore}}个/月</span>
                        <span v-else-if="bzedit === 1"><input type="number" step="0.01" v-model="userLevelStandardDetail.greatMore">个/月</span>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cGreen">
                    ...
                    <p class="col-md-4">
                        <span v-if="yedit === 0">实际>={{userLevelStandardDetail.greatMore}}个</span>
                        <span v-else-if="yedit === 1">实际>= <input type="number" step="0.01" v-model="userLevelStandardDetail.greatMore">个</span>
                    </p>
                    <p class="col-md-4">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cLightGreen">
                    ...
                    <p class="col-md-4">
                        <span v-if="ledit === 0">{{userLevelStandardDetail.goodMore}}个&lt;=实际&lt;{{userLevelStandardDetail.greatMore}}个</span>
                        <span v-else-if="ledit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.goodMore">个&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.greatMore">个
                        </span>
                    </p>
                    <p class="col-md-4">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cOrange">
                    ...
                    <p class="col-md-4">
                        <span v-if="zedit === 0">{{userLevelStandardDetail.averageMore}}个&lt;=实际&lt;{{userLevelStandardDetail.goodMore}}个</span>
                        <span v-else-if="zedit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.averageMore">个&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.goodMore">个
                        </span>
                    </p>
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cRed">
                    ...
                    <p class="col-md-4">
                        <span v-if="cedit === 0">{{userLevelStandardDetail.badMore}}个&lt;=实际&lt;{{userLevelStandardDetail.averageMore}}个</span>
                        <span v-else-if="cedit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.badMore">个&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.averageMore">个
                        </span>
                    </p>
...
export default {
    ...
    methods: {
        ...
        UdateStayLevelYJ () {
            ...
            this.$set(this.userLevelStandardDetail, 'abilityType', 98)
        ...
        UdateStayLevel () {
            getWarehouseResultDetail({ abilityLevel: this.leftInfo.grade, abilityType: 98, greatMore: this.greatMore }).then((result) => {
                if (result.data.StatusCode === 0) {
                    this.$message({
                        type: 'info',
                        message: '修改成功'
