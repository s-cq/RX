        ...
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="137">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    ...
                    <div class="col-md-2">
                        ...
                        <span v-if="bzedit === 0">5个五星/月</span>
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cLightGreen">
                    ...
                    <!-- <p class="col-md-4">
                        <span v-if="ledit === 0">{{userLevelStandardDetail.goodMore}}万&lt;=实际&lt;{{userLevelStandardDetail.goodLess}}万</span>
                        <span v-else-if="ledit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.goodMore">万&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.goodLess">万
                        </span>
                    </p> -->
                    <!-- <p class="col-md-2">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cOrange">
                    ...
                    <!-- <p class="col-md-4">
                        <span v-if="zedit === 0">{{userLevelStandardDetail.averageMore}}万&lt;=实际&lt;{{userLevelStandardDetail.averageLess}}万</span>
                        <span v-else-if="zedit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.averageMore">万&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.averageLess">万
                        </span>
                    </p> -->
                    <!-- <p class="col-md-2">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cRed">
                    ...
                    <!-- <p class="col-md-4">
                        <span v-if="cedit === 0">{{userLevelStandardDetail.badMore}}万&lt;=实际&lt;{{userLevelStandardDetail.badLess}}万</span>
                        <span v-else-if="cedit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.badMore">万&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.badLess">万
                        </span>
                    </p> -->
                    <!-- <p class="col-md-2">
