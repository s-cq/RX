<template>
    <div class="layerRtb layerRtb-threecolumn">
        <three-title :title="{name:'累计金额'}"></three-title>
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="137">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    ...
                    <div class="col-md-4">
                        ...
                        <span v-if="bzedit === 0">{{userLevelStandardDetail.greatMore}}万</span>
                        <span v-else-if="bzedit === 1"><input type="number" step="0.01" v-model="userLevelStandardDetail.greatMore">万</span>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="analyItem">
                <p class="analyItemTit tx-center">累计金额</p>
...
export default {
    ...
    methods: {
        load () {
            // 增项
            getWarehouseResultDetail({ abilityLevel: this.leftInfo.grade, abilityType: 100 }).then((result) => {
        ...
        UdateStayLevelYJ () {
            ...
            this.$set(this.userLevelStandardDetail, 'abilityType', 100)
        ...
        UdateStayLevel () {
            getWarehouseResultDetail({ abilityLevel: this.leftInfo.grade, abilityType: 100, greatMore: this.greatMore }).then((result) => {
                if (result.data.StatusCode === 0) {
                    this.$message({
                        type: 'info',
                        message: '修改成功'
