        ...
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="137">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    <div class="col-md-2"><span class="cLightGray pr8"></span><span>{{leftInfo.grade}}级</span></div>
                    <!-- <div class="col-md-4">
                    <span class="cLightGray pr8">标准</span>
                    <span v-if="bzedit === 0">{{warehouseinfo.orderCompletionRate}}%/周</span>
                    <span v-else-if="bzedit === 1"><input type="number"  step="0.01" v-model="warehouseinfo.orderCompletionRate">%/周</span>
                </div> -->
                    <div class="col-md-3">
                        <span class="cLightGray pr8">标准</span>
                        <span v-if="bzedit === 0">{{userLevelStandardDetail.greatMore}}%/月</span>
                        <span v-else-if="bzedit === 1"><input type="number" step="0.01" v-model="userLevelStandardDetail.greatMore">%/月</span>
                    </div>
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cLightGreen">
                    ...
                    <p class="col-md-4">
                        <span v-if="ledit === 0">{{userLevelStandardDetail.goodMore}}%&lt;=实际&lt;{{userLevelStandardDetail.greatMore}}%</span>
                        <span v-else-if="ledit === 1">
                            <input type="number" step="0.01" v-model="userLevelStandardDetail.goodMore">%&lt;=
                            实际
                            &lt;<input type="number" step="0.01" v-model="userLevelStandardDetail.greatMore">%
                        </span>
                    </p>
                    <p class="col-md-2">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cOrange">
                    ...
                    <p class="col-md-4">
                        <span v-if="zedit === 0">{{userLevelStandardDetail.averageMore}}%&lt;=实际&lt;{{userLevelStandardDetail.goodMore}}%</span>
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon cRed">
                    ...
                    <p class="col-md-4">
                        <span v-if="cedit === 0">{{userLevelStandardDetail.badMore}}%&lt;=实际&lt;{{userLevelStandardDetail.averageMore}}%</span>
