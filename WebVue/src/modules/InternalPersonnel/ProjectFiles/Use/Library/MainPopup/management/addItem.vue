        ...
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="137">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    <div class="col-md-2"><span class="cLightGray pr8"></span><span>{{userLevelStandardDetail.abilityLevel}}级</span></div>
                    <div class="col-md-4">
...
export default {
    ...
    methods: {
        ...
        UdateStayLevelYJ () {
            ...
            this.$set(this.userLevelStandardDetail, 'abilityType', 10)
        ...
        UdateStayLevel () {
            getWarehouseResultDetail({ abilityLevel: this.leftInfo.grade, abilityType: 10, greatMore: this.greatMore }).then((result) => {
                if (result.data.StatusCode === 0) {
                    this.$message({
                        type: 'info',
                        message: '修改成功'
