<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="10">
            <router-link tag="div" :to="{name:'grandTotal',params:{userLevelStandardDetail: userLevelStandardDetail}}" class="analyItem anItemBor" active-class="anItemBor-active">
                ...
                <div class="analyItemCon">
                    ...
                    <div class="col-md-3"><span class="cLightGray pr8">标准</span><span>{{userLevelStandardDetail.greatMore}}万</span></div>
                </div>
            </router-link>
