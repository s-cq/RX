<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="84">
            <router-link tag="div" :to="{name:'salaryBasesalary3',params:{body:body}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryResult3',params:{stayStayResult:body.stayStayResult}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryManagement3',params:{stayStayManagement:body.stayStayManagement}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryProcess3',params:{order:order,orderDetail:orderDetail,orderCount:orderCount}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('salaryRewardandpunishment3')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('salaryHistory3')" class="analyItem anItemBor" active-class="anItemBor-active">
        ...
        <div class="pr10">
            <router-link tag="div" :to="routerPath('salaryComprehensive3')" class="analyItem anItemBor" active-class="anItemBor-active">
