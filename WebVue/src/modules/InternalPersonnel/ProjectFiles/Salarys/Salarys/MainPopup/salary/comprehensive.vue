    ...
    <div class="layerRtb layerRtb-threecolumn">
        ...
        <div class="threeScroll pl10 pr5" style="height: 362px; overflow: hidden; width: auto;" v-scrollHeight="18">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    <div class="col-md-10">
                        <p class="col-md-2"><span class="cLightGray pr8">普级</span></p>
                        <p class="col-md-2"><span class="cLightGray pr8">管级</span></p>
                        ...
                        <p class="col-md-2"><span>{{body.abilityLevel}}</span></p>
                        <p class="col-md-2"><span>{{body.manageLevel}}</span></p>
                        ...
                        <!-- <input id="baseManageSalary" type="hidden" value="0"> -->
                    </div>
                    <div class="col-md-2">
                        <p><span class="cLightGray pr8">实薪</span></p>
                        <p>{{Number(body.baseManageSalary+body.adjustMoney+body.evaluateMoney+body.manualChangeWages).toFixed(2)}} </p>
                    </div>
                </div>
            </div>
            <div class="analyItem">
        ...
        <div class="layerRtb-footer">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    <div class="col-md-10">
                        <p class="col-md-3"><span class="cLightGray pr8">总收</span>{{body.trueSalary}}</p>
                        <p class="col-md-3"><span class="cLightGray pr8">底薪</span>{{Number(body.baseSalary+body.manageSalary).toFixed(2)}}</p>
                        <p class="col-md-3"><span class="cLightGray pr8">过程</span>{{(Number(body.orderMoney)+Number(workerDetails.workerSumMoney===null?0:workerDetails.workerSumMoney)).toFixed(2)}}</p>
                        <p class="col-md-3"><span class="cLightGray pr8">结果</span>{{Number(completion_money+fine_money+negotiate_profit).toFixed(2)}}</p>
                        <p class="col-md-3"><span class="cLightGray pr8">奖罚</span>{{body.punishTotalMoney}}</p>
                        <p class="col-md-3"><span class="cLightGray pr8">管理</span>{{Number(completion_moneys+fine_moneys+negotiate_profits).toFixed(2)}}</p>
