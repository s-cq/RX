<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'resultCompletion',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'resultFine',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'resultNegotiation',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
