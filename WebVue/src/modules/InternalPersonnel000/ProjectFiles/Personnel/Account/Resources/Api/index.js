 ...
 * 描述: 得到账结果数据
 */
export function getStayRoyaltyRatio (params) {
    return Request.http.post(
        '/api/personelPersonel/getStayRoyaltyRatio',
        params,
        34,
        { dataType: 'json' }
    )
 ...
 * 描述: 得到用户角色姓名和级别
 */
export function getWorkOrderCard (params) {
    return Request.http.get(
        '/api/personelPersonel/getUserjibieInfo',
        params,
        26
 ...
 * 描述: 得到用户角色姓名和级别
 */
export function GetWageRecord (params) {
    return Request.http.get(
        '/api/common/GetWageRecord',
        params,
        43
    )
}
