<template>
    <div class="">
        <div class="pr10">
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    <p class="col-md-6"><span class="cLightGray pr8">预计本月</span> <span>{{Number(body.trueSalary).toFixed(2)}}</span></p>
                </div>
            </div>
        </div>
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'salaryBasesalary2',params:{body:body}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryResult2',params:{stayStayResult:body.stayStayResult}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryManagement2',params:{stayStayManagement:body.stayStayManagement}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryProcess2',params:{order:order,orderDetail:orderDetail,orderCount:orderCount,orderMoney:body.orderMoney}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('salaryRewardandpunishment2')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('salaryHistory2')" class="analyItem anItemBor" active-class="anItemBor-active">
        ...
        <div class="pr10">
            <router-link tag="div" :to="routerPath('salaryComprehensive2')" class="analyItem anItemBor" active-class="anItemBor-active">
                <p class="analyItemTit tx-center">综合</p>
                <div class="analyItemCon">
                    <p class="col-md-4"><span class="cLightGray pr8"></span><span></span></p>
                    <p class="col-md-4"><span class="cLightGray pr8"></span><span></span></p>
                    <p class="col-md-4"><span class="cLightGray pr8">预计收入</span><span class="pr8 cGreen">{{planMoney}}</span></p>
                </div>
            </router-link>
        </div>
    </div>
...
import { getStayStaySalaryDetail, getValueAddServicesBySupervisionCard } from '../Resources/Api'
export default {
    data () {
        return {
            body: {},
