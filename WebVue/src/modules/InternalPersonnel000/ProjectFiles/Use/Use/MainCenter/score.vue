<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="routerPath('personnelEntrance2')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelInformation2')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelPosition2',params:{user:user,abilityLevel:abilityLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelGenerallevel2',params:{isGroup:isGroup,gradeByAbilityLevel:gradeByAbilityLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelManagementlevel2',params:{isGroup:isGroup,gradeByManageLevel:gradeByManageLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelKeypoint2')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelTraining2')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelCertificate2')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelNotice2')" class="analyItem anItemBor" active-class="anItemBor-active">
        ...
        <div class="pr10">
            <router-link tag="div" :to="routerPath('personnelHandling2')" class="analyItem anItemBor" active-class="anItemBor-active">
