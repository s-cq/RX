...
<div class="layerRtb layerRtb-threecolumn">
    <three-title :title="{name:'项目'}"></three-title>
    <div class="layerRtb-scroll thinScroll" v-scrollHeight = "200">
        <!-- <div class="analyItem">
            <p class="analyItemTit tx-center">洽商</p>
            <div class="analyItemCon">
                <p class="col-md-4"><span class="cLightGray pr8">洽商利润</span><span class="cGreen">0.00</span></p>
                <p class="col-md-4"><span class="cLightGray pr8">公式</span><span class="cGreen">洽商利润*45.0%</span></p>
                <p class="col-md-4"><span class="cLightGray pr8">洽商提成</span><span class="cGreen">0.00</span></p>
            </div>
        </div> -->
    </div>
        ...
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <div class="col-md-12 pt5">
                    <p class="col-md-3"><span class="cLightGray pr8">标准</span><span>{{standValue === null ? '' : standValue.toFixed(2)}}万</span></p>
                    <p class="col-md-3"><span class="cLightGray pr8">实际</span><span class="cGreen">{{complete === null ? '' : (complete / 10000).toFixed(2)}}万</span></p>
                    <p class="col-md-3"><span class="cLightGray pr8">差额</span><span class="cRed">{{Difference}}万</span></p>
                </div>
                <div class="col-md-12">
...
export default {
    ...
    computed: {
        ...
        Difference () {
            ...
            const completionMoney = this.complete ? this.complete / 10000 : 0
        ...
        submitData () {
            if (this.prizeMoney === '' || this.penaltyMoney === '') {
                ...
                let prams = {
                    ...
                    evaluateFlag: 2,
                    actualCount: this.complete ? this.complete / 10000 : 0,
                    actualNo: 0,
