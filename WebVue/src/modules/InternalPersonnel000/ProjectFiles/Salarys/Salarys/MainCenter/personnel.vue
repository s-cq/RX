<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="87">
            <router-link tag="div" :to="routerPath('personnelEntrance4')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelInformation4')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelPosition4',params:{user:user,abilityLevel:abilityLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelGenerallevel4',params:{isGroup:isGroup,gradeByAbilityLevel:gradeByAbilityLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'personnelManagementlevel4',params:{isGroup:isGroup,gradeByManageLevel:gradeByManageLevel}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelKeypoint4')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelTraining4')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelCertificate4')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('personnelNotice4')" class="analyItem anItemBor" active-class="anItemBor-active">
        ...
        <div class="pr10">
            <router-link tag="div" :to="routerPath('personnelHandling4')" class="analyItem anItemBor" active-class="anItemBor-active">
...
export default {
    ...
    methods: {
        ...
        load () {
            ...
            getUseUseTwoEndUserDetail({ user_card_no: this.leftInfo.u_kahao, login_card_no: this.userInfo.as_cardNo, pointTime: this.pointTime })
                .then(result => {
            ...
            selectComCareInfoUseHuman({ cardNo: this.leftInfo.u_kahao, pointTime: this.pointTime })
                .then(msg => {
            ...
            var isapp = 5
            getAppNoticeGroup({ cardNo: this.leftInfo.u_kahao, isapp, pointTime: this.pointTime })
                .then(result => {
