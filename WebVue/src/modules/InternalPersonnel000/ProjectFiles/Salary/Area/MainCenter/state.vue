            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    <div class="fl col-md-4">
                        <span class="cLightGray pr8">底薪</span><span class="cGreen">{{(Number(ordinarySalary) + Number(manageSalary)+Number(salaryModel.AdjustMoney)).toFixed(2)}}</span>
                    </div>
                    <div class="fl col-md-4">
                    ...
                    <div class="fl col-md-4">
                        <span class="cLightGray pr8">周月评</span><span class="cGreen">{{Number(salaryModel.EvaluateMoney).toFixed(2)}}</span>
                    </div>
                    <div class="fl col-md-4">
