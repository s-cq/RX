<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'resultCompletion3',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'resultFine3',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'resultNegotiation3',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
