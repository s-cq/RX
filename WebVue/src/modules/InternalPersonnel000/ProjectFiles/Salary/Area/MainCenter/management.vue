<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'managementCompletion3',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'managementFine3',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'managementNegotiation3',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
