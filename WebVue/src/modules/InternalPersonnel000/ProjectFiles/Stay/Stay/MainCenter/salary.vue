<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'salaryBasesalary',params:{body:body}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryResult',params:{stayStayResult:body.stayStayResult}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryManagement',params:{stayStayManagement:body.stayStayManagement}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'salaryProcess',params:{order:order,orderDetail:orderDetail,orderCount:orderCount,orderMoney:body.orderMoney}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('salaryRewardandpunishment')" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="routerPath('salaryHistory')" class="analyItem anItemBor" active-class="anItemBor-active">
        ...
        <div class="pr10">
            <router-link tag="div" :to="routerPath('salaryComprehensive')" class="analyItem anItemBor" active-class="anItemBor-active">
