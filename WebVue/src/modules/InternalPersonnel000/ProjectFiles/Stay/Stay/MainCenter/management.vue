<template>
    <div class="">
        ...
        <div class="thinScroll pr10" v-scrollHeight="94">
            <router-link tag="div" :to="{name:'managementCompletion',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'managementFine',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
            ...
            <router-link tag="div" :to="{name:'managementNegotiation',params:{completionList:completionList}}" class="analyItem anItemBor" active-class="anItemBor-active">
