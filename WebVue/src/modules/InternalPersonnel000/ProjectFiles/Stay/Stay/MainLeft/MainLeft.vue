                    ...
                    <tr class="tr-show" v-show="!seachIco">
                        ...
                        <th width="15%" class="tx-center">
                            <select class="theadselect thinScroll">
                                ...
                                <option value="1" @click="userTypeClick(1)">正常</option>
                                <option value="2" @click="userTypeClick(1)">整改</option>
                                <option value="4" @click="userTypeClick(1)">淘汰</option>
                            </select>
                        </th>
                        <th width="15%" class="tx-center">
                            <select class="theadselect thinScroll">
...
export default {
    ...
    // this.loadInternelUserThreeStageFn()
    },
    methods: {
        ...mapMutations({
