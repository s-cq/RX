...
<div class="layerRtb layerRtb-threecolumn">
    ...
    <div class="layerRtb-footer">
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                   <p class="fr col-md-3">
                    <span class="cLightGray">竣工超期：</span>
                    <span class="cGreen fz14 bold">{{timoutDay?timoutDay.finishDay:0}}天</span>
                </p>
    ...
    methods: {
        ...
        GetCompleteTimout () {
            ...
            GetOverTime({
                ...
                _this.timoutDay = results.data.Body
            })
        }
    },
    watch: {
