<template>
    <div class="layerRtb layerRtb-threecolumn">
        <three-title :title="{name:'拒单'}"></three-title>
        <div class="layerRtb-scroll thinScroll" v-scrollHeight="437" v-if="rejectUser.length>0">
            <div class="analyItem"  v-for="(item,index) in rejectUser" :key="index">
    ...
    methods: {
        GetDeposit () {
            ...
            getDepositDetail({
                ...
                _this.rejectUser = results.data.Body
            }).catch(error => {
                console.log(error)
            })
        }
