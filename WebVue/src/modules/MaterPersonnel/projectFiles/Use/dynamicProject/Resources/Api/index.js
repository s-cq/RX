...
export function getUseUserList (params) {
    return Request.http.post('/use/businesstask/getUseUserList', params, 21, {dataType: 'json'})
}

export function getDepositDetail (params) {
    return Request.http.get('/api/projectOrder/getEvaluateByPmID', params, 21)
}
/**
 * 创建: 刘江涛
 * 时间: 2019-10-21
 * 参数: params：pmId 	项目经理卡号
 * 描述: 获取项目经理评价集合
 */
export function getEvaluateByPmID (params) {
    return Request.http.post('/use/businesstask/getEvaluateByPmID', params, 21, {dataType: 'json'})
}
export function getIntegralMsg (params) {
    return Request.http.post('/use/businesstask/getIntegralMsg', params, 21, {dataType: 'json'})
}
