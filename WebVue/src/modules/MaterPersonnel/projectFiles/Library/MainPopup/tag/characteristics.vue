...
<div class="layerRtb layerRtb-threecolumn">
    <three-title :title="{name:'特征'}"></three-title>
    <div class="layerRtb-scroll thinScroll" v-scrollHeight = "137">
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <p class="col-md-2">
                    <span aria-hidden="true" class="iconfont icon-add icon-2x bold pointer cBlue fr mt2 mr5" @click='fourIndex = 0' data-title="添加类别"></span>
                </p>
            </div>
        </div>
        <div class="analyItem" v-for="(item,index) in userMarket" :key="index" >
            ...
            <div class="analyItemCon">
                ...
                <p class="col-md-2">
                 ...
                 <el-button type="primary" icon="el-icon-edit" size="small" round  @click='fourIndex = 0'></el-button>
            </div>
        </div>
    </div>
...
import rxRight from './tagThree/characterstics.vue'
export default {
    components: {
        rxRight
    },
