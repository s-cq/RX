...
<div class="layerRtb layerRtb-threecolumn">
    ...
    <div class="layerRtb-scroll thinScroll" v-scrollHeight = "137">
        <div :class="['analyItem', 'anItemBor', fiveIndex === index ? 'anItemBor-active' : '']" v-for="(item,index) in orderDetetail" :key = "index" @click="fourShow(index,item.name,item.requestPath, item.type, item.role)">
  ...
  <!-- 四段渲染容器 -->
    <transition-group class="animated faster" enter-active-class="animated faster slideInRight" leave-active-class="animated faster slideOutRight">
        <!-- 物业办理 -->
        <rx-propertyFive1 v-if="fiveIndex === 0 && orderTypeId === 2" :key="0" :type="type" :role="role"></rx-propertyFive1>
        <rx-propertyFive2 v-if="fiveIndex === 1 && orderTypeId === 2" :key="1" :type="type" :role="role"></rx-propertyFive2>
        <rx-propertyFive3 v-if="fiveIndex === 2 && orderTypeId === 2" :key="2" :type="type" :role="role"></rx-propertyFive3>
        <rx-propertyFive4 v-if="fiveIndex === 3 && orderTypeId === 2" :key="3" :type="type" :role="role"></rx-propertyFive4>
        <rx-propertyFive5 v-if="fiveIndex === 4 && orderTypeId === 2" :key="4" :type="type" :role="role"></rx-propertyFive5>
        <rx-propertyFive6 v-if="fiveIndex === 5 && orderTypeId === 2" :key="5" :type="type" :role="role"></rx-propertyFive6>

        <!-- 摄像头 -->
        <rx-cameraFive1 v-if="fiveIndex === 0 && orderTypeId === 6" :key="0" :code='this.code' :type="type" :role="role"></rx-cameraFive1>
        <rx-cameraFive2 v-if="fiveIndex === 1 && orderTypeId === 6" :key="1" :code='this.code' :type="type" :role="role"></rx-cameraFive2>
        <rx-cameraFive3 v-if="fiveIndex === 2 && orderTypeId === 6" :key="2" :code='this.code' :type="type" :role="role"></rx-cameraFive3>
        <rx-cameraFive4 v-if="fiveIndex === 3 && orderTypeId === 6" :key="3" :code='this.code' :type="type" :role="role"></rx-cameraFive4>
        <rx-cameraFive5 v-if="fiveIndex === 4 && orderTypeId === 6" :key="4" :code='this.code' :type="type" :role="role"></rx-cameraFive5>

        <!-- 开工仪式 -->
        <rx-ceremonyFive1 v-if="fiveIndex === 0 && orderTypeId === 21" :key="0" :type="type" :role="role"></rx-ceremonyFive1>
        <rx-ceremonyFive2 v-if="fiveIndex === 1 && orderTypeId === 21" :key="1" :type="type" :role="role"></rx-ceremonyFive2>
        <rx-ceremonyFive3 v-if="fiveIndex === 2 && orderTypeId === 21" :key="2" :type="type" :role="role"></rx-ceremonyFive3>
        <rx-ceremonyFive4 v-if="fiveIndex === 3 && orderTypeId === 21" :key="3" :type="type" :role="role"></rx-ceremonyFive4>
        <rx-ceremonyFive5 v-if="fiveIndex === 4 && orderTypeId === 21" :key="4" :type="type" :role="role"></rx-ceremonyFive5>
        <!-- 现场 -->
        <rx-senceFive1 v-if="fiveIndex === 0 && (orderTypeId ===4 || orderTypeId === 7 || orderTypeId === 9)" :key="0" :titleName="titleName" :url="url" :type="type" :role="role"></rx-senceFive1>
        <rx-senceFive2 v-if="fiveIndex === 1 && (orderTypeId ===4 || orderTypeId === 7 || orderTypeId === 9)" :key="1" :titleName="titleName" :url="url" :type="type" :role="role"></rx-senceFive2>
        <rx-senceFive3 v-if="fiveIndex === 2 && (orderTypeId ===4 || orderTypeId === 7 || orderTypeId === 9)" :key="2" :titleName="titleName" :url="url" :type="type" :role="role"></rx-senceFive3>
        <rx-senceFive4 v-if="fiveIndex === 3 && (orderTypeId ===4 || orderTypeId === 7 || orderTypeId === 9)" :key="3" :titleName="titleName" :url="url" :type="type" :role="role"></rx-senceFive4>
        <!-- 临电 -->
        <rx-provisionFive1 v-if="fiveIndex === 0 &&  orderTypeId === 8" :key="0" :titleName="titleName" :url="url" :type="type" :role="role"></rx-provisionFive1>
        <rx-provisionFive2 v-if="fiveIndex === 1 &&  orderTypeId === 8" :key="1" :titleName="titleName" :url="url" :type="type" :role="role"></rx-provisionFive2>
        <rx-provisionFive3 v-if="fiveIndex === 2 &&  orderTypeId === 8" :key="2" :titleName="titleName" :url="url" :type="type" :role="role"></rx-provisionFive3>
        <!-- 延期订单 -->
        <rx-delayFive1 v-if="fiveIndex === 0 &&  orderTypeId === 15" :key="0" :type="type" :role="role"></rx-delayFive1>
        <rx-delayFive2 v-if="fiveIndex === 1 &&  orderTypeId === 15" :key="1" :type="type" :role="role"></rx-delayFive2>
        <rx-delayFive3 v-if="fiveIndex === 2 &&  orderTypeId === 15" :key="2" :type="type" :role="role"></rx-delayFive3>
        <!-- 投诉订单 -->
        <rx-complaintFive1 v-if="fiveIndex === 0 &&  orderTypeId === 18" :key="0"  :type="type" :role="role"></rx-complaintFive1>
        <rx-complaintFive2 v-if="fiveIndex === 1 &&  orderTypeId === 18" :key="1"  :type="type" :role="role"></rx-complaintFive2>
        <rx-complaintFive3 v-if="fiveIndex === 2 &&  orderTypeId === 18" :key="2"  :type="type" :role="role"></rx-complaintFive3>
        <rx-complaintFive4 v-if="fiveIndex === 3 &&  orderTypeId === 18" :key="3"  :type="type" :role="role"></rx-complaintFive4>
        <!-- 竣工总检 -->
        <rx-completedFive1 v-if="fiveIndex === 0 &&  orderTypeId === 18" :key="0"  :type="type" :role="role"></rx-completedFive1>
        <rx-completedFive2 v-if="fiveIndex === 1 &&  orderTypeId === 18" :key="1"  :type="type" :role="role"></rx-completedFive2>
        <rx-completedFive3 v-if="fiveIndex === 2 &&  orderTypeId === 18" :key="2"  :type="type" :role="role"></rx-completedFive3>
        <rx-completedFive4 v-if="fiveIndex === 3 &&  orderTypeId === 18" :key="3"  :type="type" :role="role"></rx-completedFive4>
...
export default {
    ...
    methods: {
        ...
        // 点击切换Index
        fourShow (index, name, url, type, roleId) {
