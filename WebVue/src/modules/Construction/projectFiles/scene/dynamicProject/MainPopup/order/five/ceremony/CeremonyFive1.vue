...
<div class="layerRtb layerRtb-threecolumn layerRtb-right">
    <three-title :title="{name:'物品准备'}" :close="false">
        ...
        <div class="analyItem"  v-for="(item, index) of protectList" :key="index" >
            ...
            <div class="analyItemCon">
                <div class="fixedBox  flex">
                    ...
                    <el-checkbox  v-if=" item.isPlan === 1 " checked v-model="checkID[item.id]" @change="selctChange(item.id,index)"></el-checkbox>
        ...
        load () {
            ...
            getStartingItem(parm).then((result) => {
                if (result.data.StatusCode === 1) {
                    _this.protectList = result.data.Body.startingItemList
                    this.protectList.forEach(element => {
                        if (element.isPlan === 1) {
                            this.checkID[element.id] = true
                            this.selectNumber += 1
