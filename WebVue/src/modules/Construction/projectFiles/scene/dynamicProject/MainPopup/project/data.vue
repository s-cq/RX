...
<script>
// 注: 所有的大组件已 rx-xxx 命名
import rxTime from './data/time'
import rxMaterialRequirement from './data/materialRequirement'
import rxProtectRequirement from './data/protectRequirement'
import rxFireControl from './data/fireControl'
import rxAirConditioner from './data/airConditioner'
import rxPropertyRequirement from './data/propertyRequirement'
import rxPropertyInfo from './data/propertyInfo'
