...
<div class="layerRtb layerRtb-threecolumn layerRtb-right">
    ...
    <transition-group class="animated faster" enter-active-class="animated faster slideInRight" leave-active-class="animated faster slideOutRight">
        <!-- 安全订单 -->
        <rx-safeFive1 v-if="fiveIndex === 0 &&  (orderTypeId === 10 || orderTypeId === 25)  " :key="0" :Projectcode="Projectcode" :type="type"></rx-safeFive1>
        <rx-safeFive2 v-if="fiveIndex === 1 &&  (orderTypeId === 10 || orderTypeId === 25)" :key="1" :Projectcode="Projectcode" :type="type"></rx-safeFive2>
        <rx-safeFive3 v-if="fiveIndex === 2 &&  (orderTypeId === 10 || orderTypeId === 25)" :key="2" :Projectcode="Projectcode" :type="type"></rx-safeFive3>
        <rx-safeFive4 v-if="fiveIndex === 3 &&  (orderTypeId === 10 || orderTypeId === 25)" :key="3" :Projectcode="Projectcode" :type="type"></rx-safeFive4>
        <!-- 形象订单 -->
        <rx-imageFive1 v-if="fiveIndex === 0 && (orderTypeId === 11 ||  orderTypeId === 26)" :key="0" :Projectcode="Projectcode" :type="type"></rx-imageFive1>
        <rx-imageFive2 v-if="fiveIndex === 1 && (orderTypeId === 11 ||  orderTypeId === 26)" :key="1" :Projectcode="Projectcode" :type="type"></rx-imageFive2>
        <rx-imageFive3 v-if="fiveIndex === 2 && (orderTypeId === 11 ||  orderTypeId === 26)" :key="2" :Projectcode="Projectcode" :type="type"></rx-imageFive3>
        <rx-imageFive4 v-if="fiveIndex === 3 && (orderTypeId === 11 ||  orderTypeId === 26)" :key="3" :Projectcode="Projectcode" :type="type"></rx-imageFive4>
        <!-- 环境订单 -->
        <rx-environmentalFive1 v-if="fiveIndex === 0 && (orderTypeId === 12 ||  orderTypeId === 27)" :key="0" :Projectcode="Projectcode" :type="type"></rx-environmentalFive1>
        <rx-environmentalFive2 v-if="fiveIndex === 1 && (orderTypeId === 12 ||  orderTypeId === 27)" :key="1" :Projectcode="Projectcode" :type="type"></rx-environmentalFive2>
        <rx-environmentalFive3 v-if="fiveIndex === 2 && (orderTypeId === 12 ||  orderTypeId === 27)" :key="2" :Projectcode="Projectcode" :type="type"></rx-environmentalFive3>
        <rx-environmentalFive4 v-if="fiveIndex === 3 && (orderTypeId === 12 ||  orderTypeId === 27)" :key="3" :Projectcode="Projectcode" :type="type"></rx-environmentalFive4>
        <!-- 巡检订单 -->
        <!-- <rx-inspectionFive1 v-if="fiveIndex === 0 && (orderTypeId === 13 ||  orderTypeId === 28)" :key="0" :Projectcode="Projectcode" :type="type"></rx-inspectionFive1>
        <rx-inspectionFive2 v-if="fiveIndex === 1 && (orderTypeId === 13 ||  orderTypeId === 28)" :key="1" :Projectcode="Projectcode" :type="type"></rx-inspectionFive2>
        <rx-inspectionFive3 v-if="fiveIndex === 2 && (orderTypeId === 13 ||  orderTypeId === 28)" :key="2" :Projectcode="Projectcode" :type="type"></rx-inspectionFive3>
        <rx-inspectionFive4 v-if="fiveIndex === 3 && (orderTypeId === 13 ||  orderTypeId === 28)" :key="3" :Projectcode="Projectcode" :type="type"></rx-inspectionFive4> -->
    </transition-group>
</div>
</template>
<script>
